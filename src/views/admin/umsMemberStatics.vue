<template>
  ...
  <el-input
    ...
    <el-button type="success" style="margin-left:40px;margin-bottom:10px" @click="update()"><el-icon><Refresh /></el-icon></el-button>
        ...
        <div>
            <el-table :data="resuleData.records" stripe style="width:100%;height:590px" :row-style="{ height: '60px' }" border>
                ...
                <el-table-column prop="attendCount" label="关注数量"  align="center" />
                <el-table-column prop="commentCount" label="评价数"  align="center" />
                <el-table-column prop="consumeAmount" label="累计消费金额"  align="center" />
                <el-table-column prop="couponCount" label="优惠券数量"  align="center" />
                <el-table-column prop="fansCount" label="粉丝数量"  align="center" />
        ...
        <el-dialog v-model="dialogVisible" :title="isEdit ? '修改数据' : '新增数据'" width="600px" v-if="dialogVisible">
            <el-form ref="dialogForm" :model="itemData" :rules="rules">
                ...
                <el-form-item label="成长值" :label-width="100" prop="growth">
                    <el-input v-model.number="itemData.attendCount" autocomplete="off" type="text" />
                </el-form-item>
                <el-form-item label="积分" :label-width="100" prop="intergration">
                    <el-input v-model.number="itemData.commentCount" autocomplete="off" type="text" />
                </el-form-item>
                <el-form-item label="名称" :label-width="100" prop="name">
                    <el-input v-model.number="itemData.consumeAmount" autocomplete="off" type="text" />
                </el-form-item>
                <el-form-item label="任务类型" :label-width="100" prop="type">
                    <el-input v-model.number="itemData.couponCount" autocomplete="off" type="text" />
                </el-form-item>
                <el-form-item label="名称" :label-width="100" prop="name">
                    <el-input v-model.number="itemData.fansCount" autocomplete="off" type="text" />
                </el-form-item>
            </el-form>
            <template #footer>
...
import { getMemberStatic, getOne, save, edit, del } from '../../http/umsMemberStatics'
...
export default defineComponent({
    ...
    methods: {
        ...
        findPage() {
            getMemberStatic(this.requestData).then(res => {
                console.log(res)
